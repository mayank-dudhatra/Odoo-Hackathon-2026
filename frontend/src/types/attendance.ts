...
export interface AttendancePolicy {
  ...
  paid_leave_days_count?: number;
  sick_leave_days_count?: number;
  casual_leave_days_count?: number;
  max_unexcused_absences?: number;
  leave_type_quotas?: Record<string, number>;
  is_active: boolean;
  created_at: string;
  updated_at: string;
}
